...
fun BusinessCard() {
    Column(
        ...
        Column(modifier = Modifier.padding(bottom = 60.dp)) {
            ContactInfo(icon = Icons.Rounded.Phone, text = "+84 346460184")
            ContactInfo(icon = Icons.Rounded.Share, text = "@nguyenkhoa")
            ContactInfo(icon = Icons.Rounded.Email, text = "khoand.24ic@vku.udn.vn")
        }
    }
}
